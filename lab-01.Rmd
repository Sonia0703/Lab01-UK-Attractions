...
visitors %>% count(attraction, region)
```
...
A lot of data of n_2021 are NA.
...
**Write your answer here**
There is a small amount of attractions being visited by a large amount of visitors and a range of attractions are visited by much fewer visitors, which causes a positive skewness.
